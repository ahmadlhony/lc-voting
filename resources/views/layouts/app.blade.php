        ...
        >
            ...
            @else
                <div class="my-6 text-center ">
                    <a
                        href="{{ route('login') }}"
                        class="justify-center w-1/2 h-11 text-xs bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3 mr-2"
                    >
                        <span class="ml-1">Login</span>
                    </a>
                    <a
                        href="{{ route('register') }}"
                        class="justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold
